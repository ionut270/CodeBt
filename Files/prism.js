...
(Prism.languages.d = Prism.languages.extend("clike", {
	...
	number: [
		...
		{ pattern: /((?:\.\.)?)(?:\b0b\.?|\b|\.)\d[\d_]*(?:(?!\.\.)\.[\d_]*)?(?:e[+-]?\d[\d_]*)?[ulfi]*/i, lookbehind: !0 },
	],
...
!(function(n) {
	(n.languages.erb = n.languages.extend("ruby", {})),
		n.languages.insertBefore("erb", "comment", { delimiter: { pattern: /^<%=?|%>$/, alias: "punctuation" } }),
...
(Prism.languages.fsharp = Prism.languages.extend("clike", {
	...
	Prism.languages.insertBefore("fsharp", "keyword", {
		preprocessor: {
			...
			alias: "property",
			inside: {
				directive: { pattern: /(\s*#)\b(?:else|endif|if|light|line|nowarn)\b/, lookbehind: !0, alias: "keyword" },
			},
		},
	}),
				...
				a.forEach(function(a) {
					!(function(a, e) {
						...
						if (t) {
							var r = t[n];
							if (!r) {
								var i = { "doc-comment": { pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/, alias: "comment" } };
								r = (t = p.languages.insertBefore(a, "comment", i))[n];
							}
							if ((r instanceof RegExp && (r = t[n] = { pattern: r }), Array.isArray(r)))
								for (var o = 0, s = r.length; o < s; o++) r[o] instanceof RegExp && (r[o] = { pattern: r[o] }), e(r[o]);
							else e(r);
						}
					})(a, function(a) {
...
(Prism.languages.jsonp = Prism.languages.extend("json", { punctuation: /[{}[\]();,.]/ })),
	Prism.languages.insertBefore("jsonp", "punctuation", { function: /[_$a-zA-Z\xA0-\uFFFF][$\w\xA0-\uFFFF]*(?=\s*\()/ });
!(function(n) {
	var e = /("|')(?:\\(?:\r\n?|\n|.)|(?!\1)[^\\\r\n])*\1/;
...
!(function(a) {
	...
	(a.languages.jsdoc = a.languages.extend("javadoclike", {
		parameter: { pattern: RegExp(s + "[$\\w\\xA0-\\uFFFF.]+(?=\\s|$)"), lookbehind: !0, inside: { punctuation: /\./ } },
	})),
...
!(function(r) {
	...
	["c", { lang: "c++", alias: "cpp" }, "fortran"].forEach(function(e) {
		...
		if (("string" != typeof e && ((t = e.alias), (e = e.lang)), r.languages[t])) {
			...
			(a["inline-lang-" + t] = {
				pattern: RegExp(
					"%< *-\\*- *{lang}\\d* *-\\*-[\\s\\S]+?%>".replace("{lang}", e.replace(/([.+*?\/\\(){}\[\]])/g, "\\$1")),
					"i",
				),
...
!(function(a) {
	...
	for (
		var e = ["function", "function-variable", "method", "method-variable", "property-access"], t = 0;
		t < e.length;
		t++
	) {
		var n = e[t],
			...
			phrase: {
				...
				inside: {
					"block-tag": {
						...
						inside: {
							modifier: { pattern: RegExp("(^[a-z]\\w*)(?:" + n + "|[<>=()])+(?=\\.)"), lookbehind: !0, inside: i },
							tag: /^[a-z]\w*/,
							punctuation: /\.$/,
						},
					},
					list: {
						...
						inside: { modifier: { pattern: RegExp("(^[*#]+)" + n), lookbehind: !0, inside: i }, punctuation: /^[*#]+/ },
					},
					table: {
						pattern: RegExp(
							"^(?:(?:" + n + "|[<>=()^~])+\\.\\s*)?(?:\\|(?:(?:" + n + "|[<>=()^~_]|[\\\\/]\\d+)+\\.)?[^|]*)+\\|",
					...
					inline: {
						...
						inside: {
							...
							cite: { pattern: RegExp("(^\\?\\?(?:" + n + ")?).+?(?=\\?\\?)"), lookbehind: !0, alias: "string" },
...
!(function(t) {
	...
	(t.languages.soy = {
		...
		t.hooks.add("before-tokenize", function(e) {
			var a = !1;
			t.languages["markup-templating"].buildPlaceholders(e, "soy", /{{.+?}}|{.+?}|\s\/\/.*|\/\*[\s\S]*?\*\//g, function(
				e,
			) {
...
!(function(t) {
	(t.languages.tt2 = t.languages.extend("clike", {
		...
		t.languages.insertBefore("tt2", "keyword", { delimiter: { pattern: /^(?:\[%|%%)-?|-?%]$/, alias: "punctuation" } }),
				...
				if (
					("string" != typeof a &&
						("tag" === a.type && a.content[0] && "tag" === a.content[0].type
							...
							? 0 < t.length && 0 < t[t.length - 1].openedBraces && "punctuation" === a.type && "}" === a.content
